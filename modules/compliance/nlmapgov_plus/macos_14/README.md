# Netherlands BIO — Plus — macOS 14

## Overview

- **Baseline key**: `nlmapgov_plus`
- **Category**: government
- **macOS version**: 26 (14.0+)
- **mSCP branch**: `tahoe`
...
```hcl
module "nlmapgov_plus_macos_14" {
  source = "./modules/compliance/nlmapgov_plus/macos_14"
